<!DOCTYPE HTML>
    <html>
        ...
        <link rel="icon" href="favico.ico">
            <meta charset="utf-8">
            <title>تم إضافة المصطلح بنجاح</title>
            <style>
        ...
        <body>
            ...
            <div class="content">
                <?php
                    include("cdb.php");
                    $enword = $_POST['addenword'];
                    $arword = $_POST['addarword'];
                    $add = ("INSERT INTO words (id, enword, arword) VALUES (NULL, '$enword', '$arword')");
                    $db->exec($add);
                    echo "<h1>";
                    echo "تم إضافة المصطلح بنجاح";
                    echo "</h1>";
                ?>
        <br>
            <div class="footer">
