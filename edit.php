        ...
        <body>
            ...
            <div class="content">
                <table>
                    <tr>
                    <br>
                        <a href="editen.php"><input type="button" value="تعديل مصطلح في اللغة الإنجليزية" class="tbtn"></a>
                        <a href="editar.php"><input type="button" value="تعديل مصطلح في اللغة العربية" class="tbtn"></a>
                    <tr>
                </table>
        <br>
            <div class="footer">
